# Gemini Platform Switch (AI Insight Backend) Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Switch AI Insight backend generation to Gemini proxy with Claude Sonnet 4.5 fallback, leaving translation workflows on Claude.
...
**Step 2: Verify no translation workflow changes**

No changes to `Hextra-AI-Insight-Daily/.github/workflows/*`.
