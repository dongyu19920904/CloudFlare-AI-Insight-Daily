...
function buildDailyRepairPrompt(basePromptInput, invalidMarkdown, validationIssues, dateStr) {
    ...
    return [
        ...
        "- 每条正文写 4-5 个短句，每句尽量不超过 45 个可见字符，总长约 120-170 字；覆盖结论、来源事实、关键数字或限制、读者影响，按信息关系组织，不固定第二句报来源、第三句列参数、第四句给行动。标题、开头和正文应递进，不重复同一标题，不通过删除事实来缩短；没有来源支持且具体可行的动作时，用真实限制或具体影响收尾，不写机械的“今天试试”或行业口号",
