...
function buildOpportunityRepairPrompt(basePromptInput, invalidMarkdown, validationIssues) {
    return [
        ...
        "- 如果上面提示品牌露出过密，保留主推里的必要品牌名，其他栏目改写成买家场景、品类、交付物或不同产品线，不要反复念 Claude、Gemini、OpenAI/GPT",
        "- 不要为了减少重复把主推对象写成谜语；核心工具、项目或产品线必须在标题或首段点名 1 次，后面再用代称",
        "- 今日动作里同一品牌最多出现一次，优先写动作而不是重复工具名",
        "",
        "下面是原始候选素材：",
        basePromptInput,
        "",
...
function buildAccountOpportunityRepairPrompt(basePromptInput, invalidMarkdown, validationIssues) {
    return [
        ...
        "- 如果上面提示品牌露出过密，保留主推里的必要品牌名，其他栏目改写成账号品类、买家麻烦、交付边界或不同产品线，不要反复念 Claude、Gemini、OpenAI/GPT",
        "- 不要为了减少重复把主推对象写成谜语；核心账号、入口、产品线或开源项目必须在标题、首段或“发生了什么”里点名 1 次，后面再用代称",
        "- 今日动作里同一品牌最多出现一次，优先写先发什么、先录什么、先卖哪一款",
        "",
        "下面是原始候选素材：",
        basePromptInput,
        "",
